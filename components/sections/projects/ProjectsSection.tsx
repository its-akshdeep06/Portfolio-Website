...
const projects = [
  ...
  },
  {
    ...
    tag: "AI / PLATFORM",
    title: "RECONNECT",
    description: "AI-powered rehabilitation platform bridging the gap between individuals and support organizations. Features dual-role dashboards, personalized tracking, and a 24/7 AI companion powered by Llama 3.1.",
    year: "2025",
    tone: "emerald",
    tagColor: "text-emerald-500",
    borderHover: "hover:border-emerald-500/80",
    textHover: "group-hover:text-emerald-500",
    glowColor: "group-hover:shadow-[0_0_60px_rgba(16,185,129,0.6),0_0_20px_rgba(16,185,129,0.4)]",
    cardGlow: "hover:shadow-[0_20px_60px_rgba(16,185,129,0.18)] hover:border-emerald-500/40",
    github: "https://github.com/its-akshdeep06/RECONNECT",
    live: "https://reconnect01.vercel.app/",
    image: "/Reconnect.png",
  },
  {
    number: "003",
